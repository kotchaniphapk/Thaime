...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between px-4 py-4   md:px-10  md:py-4 bg-black/30 backdrop-blur-xl border-b border-white/10">
      <Link
        href="/"
      ...
      >
        ...
        <span className="">{t('menu.back')}</span>
      </Link>
      <LanguageToggle />
    </header>
  );
